...
```{r}
phyper(17255 - 1, 300000, 4564806 - 300000, 40788, lower.tail=F, log.p = T)
```
...
```{r}
lefConsSeq <- length(grep("TCAAAG|AGTTTC|GAAACT|CTTTGA", Lef1SitesSeq))
print(lefConsSeq)
lefConsSeq/length(Lef1SitesSeq)
IntConsSeq <- length(grep("TCAAAG|AGTTTC|GAAACT|CTTTGA", IntersectedSitesSeq))
print(IntConsSeq)
